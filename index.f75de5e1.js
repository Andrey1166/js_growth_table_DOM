...
if (rowQuantity >= 10) appendRowBtn.setAttribute("disabled", "");
if (rowQuantity <= 2) removeRowBtn.setAttribute("disabled", "");
if (columnQuantity >= 10) appendColumnBtn.setAttribute("disabled", "");
if (columnQuantity <= 2) removeColumnBtn.setAttribute("disabled", "");
